...
name varchar(100),  
address varchar(200),
RiskId int foreign key references Risk1(RiskId)
);  
 
insert into Risk1 (RiskName) values('Risk 1')  
insert into Risk1 (RiskName) values('Risk 2')  
insert into Risk1 (RiskName) values('Risk 3')  
